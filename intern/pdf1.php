...
/*if(!isset($_SESSION['login_user'])) 
 ...
 $sno=$_GET['generate_pdf'];
      ...
      $sql = "SELECT ticketno,status,mode,priority,location,name,site,technician,type,category,subcategory,item,email,subject,description,resolution,reason FROM incident where sno='$sno'";  
