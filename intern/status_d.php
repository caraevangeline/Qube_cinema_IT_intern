...
$status=$_GET['status'];
   ...
   // $_SESSION['varname'] = $sno;
    ...
    $result = $db->query("SELECT sno,priority,location,name,site,technician,type,category,subcategory,item,description,ticketno,status,mode,email,subject,resolution,reason,file,time1 FROM change1 where status = '$status' ");
...
$ip="";
    ...
    //echo "0 results";
    echo "<script type='text/javascript'>alert('No Change Requests on $status')</script>";
}
 ...
 $result = $db->query("SELECT sno,priority,location,name,site,technician,type,category,subcategory,item,description,ticketno,status,mode,email,subject,resolution,reason,file,time1 FROM incident where status = '$status' ");
...
$ip="";
    ...
    //echo "0 results";
    echo "<script type='text/javascript'>alert('No Incident Requests on $status')</script>";
}
