...
$priority=$_GET['priority'];
   ...
   // $_SESSION['varname'] = $sno;
    $result = $db->query("SELECT sno,priority,location,name,site,technician,type,category,subcategory,item,description,des,ticketno,status,mode,email,subject,resolution,reason,file,time1 FROM change1 where priority = '$priority' ");
